...
import {
  ...
  Button, Divider, Avatar, useTheme, Chip,
} from "@mui/material";
...
const INITIAL_REVIEWS = [
  { id: 1, name: "Anna A.", rating: 5, text: "Fantastisk butik! Snabb leverans och bra priser.", date: "2026-03-01" },
  { id: 2, name: "Erik E.", rating: 4, text: "Bra urval av spel. Lätt att hitta det man söker.", date: "2026-03-05" },
  { id: 3, name: "Maria S.", rating: 5, text: "Rekommenderar varmt! Köpte Elden Ring till bästa pris.", date: "2026-03-10" },
];
